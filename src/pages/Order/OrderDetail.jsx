...
import { Card, Descriptions, Tag, Button, Spin, Space, Row, Col, Image } from 'antd';
  ...
  return (
    <div className="page-container">
      ...
      <Row gutter={16}>
        ...
        <Col span={12}>
          <Card title="车辆信息" variant="borderless">
            <Descriptions column={1} size="small">
      ...
      <Card title="费用信息" variant="borderless" style={{  marginTop: 16 }}>
        <Descriptions bordered column={2}>
          ...
          <Descriptions.Item label="日租金">¥{order.dailyPrice?.toLocaleString() ?? '0'}</Descriptions.Item>
          <Descriptions.Item label="租金总额">¥{order.rentAmount?.toLocaleString() ?? '0'}</Descriptions.Item>
